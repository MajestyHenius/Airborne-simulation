...
This is a simple airborne linear scanning Lidar simulation system using Ray interaction in Unity3d. As the airborne platform moves, the imaging point cloud will be generated. 
The result will be saved at D:/
